...
namespace Advisor6.Migrations
{
    public partial class Acadimic : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Personal_Ifad_IfadId",
                        column: x => x.IfadId,
                        principalTable: "Ifad",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Personal_Thanks_ThanksId",
                        column: x => x.ThanksId,
                        principalTable: "Thanks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Personal_Trining_TriningId",
                        column: x => x.TriningId,
                        principalTable: "Trining",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Personal_IfadId",
                table: "Personal",
                column: "IfadId");

            migrationBuilder.CreateIndex(
                name: "IX_Personal_ThanksId",
                table: "Personal",
                column: "ThanksId");

            migrationBuilder.CreateIndex(
                name: "IX_Personal_TriningId",
                table: "Personal",
                column: "TriningId");
