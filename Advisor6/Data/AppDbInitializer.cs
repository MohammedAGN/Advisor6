    ...
    public class AppDbInitializer
    {
        ...
        public static async Task SeedUsersAndRolesAsync(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                string adminUserEmail = "SuperAdmin@Advisor.com";
                ...
                if (adminUser == null)
                {
                    ...
                    await userManager.CreateAsync(newAdminUser, "SuperAdmin");
                    await userManager.AddToRoleAsync(newAdminUser, UserRoles.SuperAdmin);
                }


                string appUserEmail = "Admin@Advisor.com";
                ...
                if (appUser == null)
                {
                    ...
                    await userManager.CreateAsync(newAppUser, "Admin");
